...
function Authorize(orderNumber, paymentInstrument, paymentProcessor) {
    ...
    try {
        tamaraServiceCheckout.initService(order, paymentInstrument, paymentProcessor);
        Transaction.wrap(function () {
            order.trackOrderChange('CheckoutServices-PlaceOrder: ' + Resource.msg('note.content.tamara.createsession', 'tamara', null));
        });
    } catch (e) {
        error = true;
        serverErrors.push(
